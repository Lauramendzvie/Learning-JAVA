public class Aluno {
    ...
    public Aluno(String nome, String EDV, int idade, String fileira) {
    ...
    @Override
    public String toString(){ // formato bonitinho de mostrar os alunos cadastrados, vou chamar isso no meu sistema pra usar
